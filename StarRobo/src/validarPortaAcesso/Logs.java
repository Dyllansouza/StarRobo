...
public class Logs {
	...
	final static String sucessoPath = "C:/Automatizacao/Star/Log/validarPortaAcesso/SUCESSO/";
	final static String erroPath = "C:/Automatizacao/Star/Log/validarPortaAcesso/ERRO/";
	...
	public static java.util.logging.Logger Logger() {
		...
		try {
			...
			fh = new FileHandler("C:/Automatizacao/Star/Log/validarPortaAcesso/validarPortaAcesso@" + Logs.Data() + ".txt");
