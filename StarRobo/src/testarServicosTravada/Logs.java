...
public class Logs {
	...
	final static String sucessoPath = "C:/Automatizacao/Star/Log/testarServicosTravada/SUCESSO/";
	final static String erroPath = "C:/Automatizacao/Star/Log/testarServicosTravada/ERRO/";
	...
	public static java.util.logging.Logger Logger() {
		...
		try {
			...
			fh = new FileHandler("C:/Automatizacao/Star/Log/testarServicosTravada/testarServicosTravada@" + Logs.Data() + ".txt");
