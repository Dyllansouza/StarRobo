...
public class Logs {
	...
	final static String sucessoPath = "C:/Automatizacao/Star/Log/validarAcessoWaiting/SUCESSO/";
	final static String erroPath = "C:/Automatizacao/Star/Log/validarAcessoWaiting/ERRO/";
	...
	public static java.util.logging.Logger Logger() {
		...
		try {
			...
			fh = new FileHandler("C:/Automatizacao/Star/Log/validarAcessoWaiting/validarAcessoWaiting@" + Logs.Data() + ".txt");
