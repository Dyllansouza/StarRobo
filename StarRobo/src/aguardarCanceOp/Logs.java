...
public class Logs {
	...
	final static String sucessoPath = "C:/Automatizacao/Star/Log/aguardarCanceOp/SUCESSO/";
	final static String erroPath = "C:/Automatizacao/Star/Log/aguardarCanceOp/ERRO/";
	...
	public static java.util.logging.Logger Logger() {
		...
		try {
			...
			fh = new FileHandler("C:/Automatizacao/Star/Log/aguardarCanceOp/aguardarCanceOp@" + Logs.Data() + ".txt");
