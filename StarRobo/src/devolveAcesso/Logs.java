...
public class Logs {
	...
	final static String sucessoPath = "C:/Automatizacao/Star/Log/devolveAcesso/SUCESSO/";
	final static String erroPath = "C:/Automatizacao/Star/Log/devolveAcesso/ERRO/";
	...
	public static java.util.logging.Logger Logger() {
		...
		try {
			...
			fh = new FileHandler("C:/Automatizacao/Star/Log/devolveAcesso/validarPortaAcesso@" + Logs.Data() + ".txt");
